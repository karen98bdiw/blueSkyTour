...
class AppSizes {
  ...
  static double pHeight(double size) {
    return MediaQuery.of(AppKeys.navigatorKey.currentContext!).size.height *
        size /
        100;
  }

  static double phHeight(double size) {
  ...
  static double phWidth(double size) {
    return width * size / 100;
  }

  static double pWidth(double size) {
    return width * size / 100;
  }
}
