...
class AppTextStyles {
  ...
  static const MENU_ITEM_TEXT_STYLE = TextStyle(
    fontSize: AppFontSizes.LARGE_TEXT,
    fontWeight: FontWeight.w800,
    color: Color.fromRGBO(1, 78, 100, 1),
  );
  static const MENU_ITEM_TEXT_STYLE_HOVERED = TextStyle(
    fontSize: AppFontSizes.LARGE_TEXT,
    fontWeight: FontWeight.w800,
    color: Color.fromRGBO(0, 144, 170, 1),
  );
}
